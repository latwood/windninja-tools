...
def Usage():
    print '\n    writeBias.py forecast_file output_file'
    print '\n    forecast_file: format must be WindNinja point output format from a wx model run.'
    print '    output_file: The output file name, .txt will be appended.'
    print '\n    Writes a .txt of WindNinja vs. observations for mulitple timesteps.' 
    sys.exit(0)
